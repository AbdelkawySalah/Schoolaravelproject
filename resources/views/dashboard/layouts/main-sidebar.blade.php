                ...
                <ul class="nav navbar-nav side-menu" id="sidebarnav">
                    ...
                    <li>
                        ...
                        <ul id="dashboard" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="index.html">{{trans('main_sidebar_trans.Dashboard 01')}}</a> </li>
                    ...
                    <li>
                        ...
                        <ul id="elements" class="collapse" data-parent="#sidebarnav">
                            <li><a href="{{route('Grades.index')}}">{{trans('main_sidebar_trans.Grades_List')}}</a></li>
                    ...
                    <li>
                        <a href="javascript:void(0);" data-toggle="collapse" data-target="#font-icon">
                            ...
                            {{trans('main_sidebar_trans.Sections')}}
                           </span>
                          </div>
                            <div class="pull-right"><i class="ti-plus"></i></div>
                            <div class="clearfix"></div>
                        ...
                        <ul id="font-icon" class="collapse" data-parent="#sidebarnav">
                            ...
                            {{trans('main_sidebar_trans.Sections_List')}}
                            </a> 
                            </li>
                        </ul>
                    </li>
                   <!-- end sections bar -->
                    ...
                    <!-- parents bar -->
                    <li>
                        <a href="javascript:void(0);" data-toggle="collapse" data-target="#calendar-menu1">
                            <div class="pull-left"><i class="ti-home"></i>
                            <span class="right-nav-text">
                            {{trans('main_sidebar_trans.Parents')}}
                           </span>
                          </div>
                            <div class="pull-right"><i class="ti-plus"></i></div>
                            <div class="clearfix"></div>
                        </a>
                        <ul id="calendar-menu1" class="collapse" data-parent="#sidebarnav">
                            <li>
                            <a href="{{route('Sections.index')}}">
                            {{trans('main_sidebar_trans.List_Parents')}}
                            </a> 
                            </li>
                            <li>
